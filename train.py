...
def train():
    ...
    log_dir = models_dir / "logs" / f"run_{timestamp}"
    model_path = models_dir / "checkpoints" / "best_model.pth"
    ...
    for epoch in range(num_epochs):
        ...
        print(f"Epoch {epoch+1}, Loss: {avg_epoch_loss:.4f}, Val Loss: {avg_val_loss:.4f}, Val Accuracy: {accuracy:.2f}%")
